...
begin
  ...
  begin
    ...
    begin
      Close;
      sql.clear;
      sql.Add('INSERT INTO tab1 (Класс, Буква, Фамилия, Имя, Отчество, Пол, Дат_рож, Foto) ');
      ...
      Close;
      sql.clear;
      sql.Add('INSERT INTO tab2 (Нац, Адрес_ул, Адрес_дом, Адрес_кв, Адрес_тел, Кл_рук_ФИО) ');
...
begin
  if Edit1.Text = 'Фамилия' then Edit1.Text:= '';
end;
...
begin
  if Edit2.Text = 'Имя' then Edit2.Text:= '';
end;
...
begin
  if Edit3.Text = 'Отчество' then Edit3.Text:= '';
end;
