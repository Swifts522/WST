...
begin
  ...
  begin
      Close;
      sql.Clear;
      sql.Add('UPDATE Accounts SET Логин = '+#39+Edit4.Text+#39+', Пароль = '+#39+Edit7.Text+#39+', ФИО = '+#39+Edit1.Text+#39+' WHERE Код = '+IntToStr(id));
      ExecSQL;
      Close;
      sql.Clear;
...
begin
  ...
  begin
    ...
    begin
      Close;
      sql.Clear;
      sql.Add('DELETE FROM Accounts WHERE Код = '+IntToStr(id));
      ExecSQL;
    end;
    with ADOQuery1 do
    begin
...
begin
  ...
  begin
    ...
    Edit7.Clear;
    Insert:= true;
    ShowMessage('Заполните поля и нажмите на кнопку добавить еще раз.');
  end
  else
  begin
    ...
    begin
      Close;
      sql.Clear;
      sql.Add('INSERT INTO Accounts (Логин, Пароль, ФИО, Доступ) VALUES('+#39+Edit4.Text+#39+', '+#39+Edit7.Text+#39+', '+#39+Edit1.Text+#39+', 0)');
      ExecSQL;
      Close;
      sql.Clear;
      sql.Add('SELECT * FROM Accounts');
